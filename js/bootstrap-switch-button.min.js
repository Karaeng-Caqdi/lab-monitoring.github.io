...
!(function () {
	class t {
		...
		render() {
			...
			e.setAttribute(
				"class",
				"btn btn-" + this.options.onstyle + " btn-" + this.options.size
			),
			...
			s.setAttribute(
				"class",
				"btn btn-" + this.options.offstyle + " btn-" + this.options.size
			),
				e.setAttribute("for", this.element.id),
			...
			i.setAttribute(
				"class",
				"switch-handle btn btn-light btn-" + this.options.size
			);
		...
		trigger(t) {
			t || this.element.dispatchEvent(new Event("change", { bubbles: !0 }));
		}
		destroy() {
	...
	(Element.prototype.switchButton = function (e, s) {
		...
		"undefined" != typeof window &&
			(window.onload = function () {
				document
					.querySelectorAll('input[type=checkbox][data-toggle="switchbutton"]')
					.forEach(function (t) {
						t.switchButton();
					});
			}),
